#!/bin/bash
################################################################################
# Script for Installation: ODOO 8 ERP on Ubuntu 14.04 LTS
...
if [ ${MACHINE_TYPE} == 'x86_64' ]; then
  reportTool="http://download.gna.org/wkhtmltopdf/0.12/0.12.1/wkhtmltox-0.12.1_linux-trusty-amd64.deb"
else
  reportTool="http://download.gna.org/wkhtmltopdf/0.12/0.12.1/wkhtmltox-0.12.1_linux-trusty-i386.deb"
fi
...
echo "Done! The ODOO server can be started with: sudo service $OE_CONFIG start"
